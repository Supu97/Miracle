        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/he.jpg" height="40px"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="contactus.php" data-toggle="contactus" data-target="contactus">Contact Us</a></li>
                        
                            
                        
                        <li><a href="ourservices.php" data-toggle="contactus" data-target="contactus">Our Services</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#myModal2"><h5>Sign Up as a Doctor</h5></a>
                                                <a href="#" data-toggle="modal" data-target="#myModal3"><h5>Sign Up as a Patiant</h5></a>
                                                </div>  
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    <label class="sr-only" for="icPatient">ID number</label>
                                                ...
                                                <div class="form-group">
                                                <a href="patient/patientdashboard.php" class="btn btn-primary">Sign In</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title">Sign Up as a Doctor</h3>
                    </div>
                    <!-- modal body start -->
                        ...
                        <div class="container" id="wrap">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="doctorsignup.php" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="number" name="icDoctor" value="" class="form-control input-lg" placeholder="Your Doctor ID Number"  required/>
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="doctorGender" value="male" required/>Male
                                        </label>
                                        <label class="radio-inline" >
                                            <input type="radio" name="doctorGender" value="female" required/>Female
                                        </label>
                                        <br />
        ...
        <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title">Sign Up as a Patiant</h3>
                    </div>
                    <!-- modal body start -->
                    <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="index.php" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="number" name="icPatient" value="" class="form-control input-lg" placeholder="Your National ID Number"  required/>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>Hurry up.we are here to serve maximum helthcare service</p>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h1>Vision</h1>
                    <hr>
                    <h2>To see a happier society with healthy individual by everyone having their basic medical needs metBeing an integral member of the healthcare team responsible for the outcomes associated with the medication use process</h2>
                </div>
            </div>
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h1>Mission</h1>
                    <hr>
                    <h2>To provide safe, high quality patient care in an atmosphere of professionalism, respect, and effective communication.</h2>
                </div>
